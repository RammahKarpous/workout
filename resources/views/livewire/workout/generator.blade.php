...
<div
	class="workout-generator flex flex-col justify-center bg-background p-4 rounded-lg border border-border">
	...
	<form wire:submit="generateWorkout" class="flex flex-col gap-4 w-full">
		...
		<button type="submit" class="dark:bg-blue-800 dark:hover:bg-blue-700 bg-blue-400 hover:bg-blue-500 transition-colors duration-200 text-text p-2 rounded-lg border border-border cursor-pointer">Generate
